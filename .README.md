...
Currently, I'm building seamless neobanking solutions at **[Novo](https://www.novo.co/)** as a **Senior Backend Engineer** (`L4`), following 4.5 years as a Software Engineer (`L1` & `L2`) at **[Postman](https://www.postman.com/)**. My notable contributions at Postman include building [Interceptor](https://learning.postman.com/docs/sending-requests/capturing-request-data/interceptor/) and [Integrations](https://www.postman.com/product/integrations/). Discover more about my [Postman journey](https://vinitshahdeo.dev/saying-goodbye-to-postman) and [valuable lessons](https://vinitshahdeo.dev/10-lessons-learned-as-software-engineer-at-postman). I've had the privilege of mentoring in GSoC at [AsyncAPI](https://github.com/asyncapi) and [Postman](https://blog.postman.com/postmans-projects-and-contributors-google-summer-of-code-2023/). For my work at Novo, you can find me as [@vinitshahdeo-novo](https://github.com/vinitshahdeo-novo).
...
During [Hacktoberfest](https://github.com/vinitshahdeo/Hacktoberfest2021), I initiated a program aimed at [helping beginners kickstart their journey into open-source](https://vinitshahdeo.dev/hacktoberfest-2021), impacting over 1200+ beginners worldwide. Currently, I'm seeking collaboration for [#50DaysOfJavaScript](https://50daysofjavascript.netlify.app/), a community-led open-source initiative aimed at enhancing JavaScript skills to ace next JS interviews. Please consider joining as a **participant**, **mentor** or a **community partner**.
